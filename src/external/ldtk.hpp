 ...
 */
enum class AllowedRefs : int16_t
{
  ANY,
  ONLY_SAME,
 ...
 */
enum class EditorDisplayMode : int16_t
{
 ...
 */
enum class EditorDisplayPos : int16_t
{
  ABOVE,
  BENEATH,
  CENTER
 ...
 */
enum class EditorLinkStyle : int16_t
{
  ARROWS_LINE,
  CURVED_ARROW,
  DASHED_LINE,
...
enum class TextLanguageMode : int16_t
{
  LANG_C,
  LANG_HAXE,
  LANG_JS,
 ...
 */
enum class LimitBehavior : int16_t
{
  DISCARD_OLD_ONES,
  MOVE_LAST_ONE,
  PREVENT_ADDING
 ...
 */
enum class TileRenderMode : int16_t
{
  COVER,
  FIT_INSIDE,
  FULL_SIZE_CROPPED,
...
enum class WorldLayout : int16_t
{
  FREE,
  GRID_VANIA,
  LINEAR_HORIZONTAL,
 ...
 */
enum class IdentifierStyle : int16_t
{
  CAPITALIZE,
  FREE,
  LOWERCASE,
 ...
 */
enum class ImageExportMode : int16_t
{
  LAYERS_AND_LEVELS,
  NONE,
  ONE_IMAGE_PER_LAYER,
...
inline void from_json(const json &j, EntityInstance &x)
{
  ...
  x.tile            = get_stack_optional<TilesetRectangle>(j, "__tile");
  x.world_x         = j.at("__worldX").get<int64_t>();
  x.world_y         = j.at("__worldY").get<int64_t>();
  x.def_uid         = j.at("defUid").get<int64_t>();
